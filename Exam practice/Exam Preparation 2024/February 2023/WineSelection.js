...
console.log(selection2.payWineBottle('Sauvignon Blanc Marlborough', 120));
console.log(selection2.payWineBottle('Bodegas Godelia Mencía', 144));
...
console.log(selection5.cellarRevision());